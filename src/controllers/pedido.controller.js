...
const postPedidos = (req, res) => {
    ...
    const alumno = { dni: 123456789, nombre: 'Nombre del Alumno', celiaco: false, edad: 18 }; // Obtener el alumno desde una fuente de datos
    if (!alumno) {
    ...
    // Verificar el tipo de vianda solicitado
    ...
    // Actualizar la vianda y desabilitar el estado del alumno
    vianda.stock--;
